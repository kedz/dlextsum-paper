...
workplace meetings (AMI), and medical journal articles (PubMed).\hal{orphan}
...
sports, and celebrity news.\hal{=entertainment?}
...
a combined summary length of at least 100 words\hal{i'm not sure what you mean here. are you concatenating the two summaries? if so, say so. is that a little weird tho?}. This collection
...
summaries. We use the proscribed\hal{hehehe i think you mean prescribed :P} splits to get 98/19/20 training, validation,
