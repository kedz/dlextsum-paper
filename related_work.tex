...
The introduction of the CNN-DailyMail corpus by \citet{nips15_hermann} \hal{bad citation style, be sure these are all fixed. (i fixed this one and will fix others that i notice.)}
...
All of the previous works \hal{all previous works mentioned? or in the whole universe? :)}
%have 
...
\hal{since you're going tot alk about redundancy, i think you need to cite MMR.}
