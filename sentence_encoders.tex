...
is simply the average of its word embeddings. \hal{get rid of orphans.}
%
...
word embeddings. The final sentence embedding $\sentEmb$ is \hal{???}; detail in \autoref{app:cnnencoder}.
